import { DataWithEmbedding, generateEmbeddings, loadJsonData } from "./main"
...
async function main() {
    const dataWithEmbedding = loadJsonData('embedding.json');
    const input = 'dog';
...
async function characteristic() {
    const dataWithEmbedding = loadJsonData('embeddingCharacteristics.json');
